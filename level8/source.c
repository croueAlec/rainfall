...

{
	...
	bVar15 = 0;
	do {
	printf("%p, %p \n",auth,service);					// auth and service are global variables
	pcVar4 = fgets((char *)local_90,0x80,stdin);		// fgets reads stdin and puts it into a buffer of size 5 : local_90 and pcVar4
	bVar9 = false;
	if (pcVar4 == (char *)0x0) {
		return 0;
	}
	...
	bVar13 = false;
	pbVar7 = local_90;
	pbVar8 = &DAT_08048819;								// this references a specific address in code
	do {
		if (iVar5 == 0) break;
		iVar5 = iVar5 + -1;
		bVar9 = *pbVar7 < *pbVar8;
	...
	uVar10 = 0;
	uVar14 = 0;
	if ((!bVar9 && !bVar13) == bVar9) {					// if false
		auth = malloc(4);
		pcVar4 = auth + 1;
		pcVar2 = auth + 2;
		pcVar3 = auth + 3;
	...
	if ((!(bool)uVar11 && !(bool)uVar14) == (bool)uVar11) {
		...
		service = strdup(acStack_89);				// actually just buffer + 0x07
	}
	iVar5 = 5;
	pbVar7 = local_90;
	pbVar8 = (byte *)"login";
